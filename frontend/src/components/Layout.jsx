    ...
    <div className="min-h-screen flex flex-col">
      <header className="border-b border-hive-border bg-hive-panel">
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center gap-6">
          <div className="flex items-center gap-2 font-mono font-extrabold uppercase tracking-wide text-sm">
            <BrandMark /> Hack the Accounts
          </div>
          ...
          <div className="ml-auto flex items-center gap-3 text-sm">
            <span className="text-hive-muted">
              ...
              <span className="ml-2 chip bg-hive-panel2 text-hive-accent uppercase">{user?.role}</span>
            </span>
